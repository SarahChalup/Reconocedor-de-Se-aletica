...
namespace CustomVision
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string ENDPOINT = "https://signaldetector.cognitiveservices.azure.com/";

            // Add your training & prediction key from the settings page of the portal

            string trainingKey = "b6985ca2051341338337ebc214870aa4";
            string predictionKey = "1709db60dc114e3bb8a93bb315d3647a";
            // </snippet_creds>
